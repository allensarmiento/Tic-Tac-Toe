...
public class EasyComputer extends MouseAdapter {
	...
	public EasyComputer(TicTacToeGame game, MainMenu mainMenu, Handler handler) {
		this.game = game;
	...
	public void mousePressed(MouseEvent e) {
		...
		if(game.gameState == GAMESTATE.Game && game.numPlayers == 1) {
			...
			// Normal and Easy game mode handling
			if(game.gameMode == 0 && gameBegin == true && game.difficulty == 0) {
			...
			// Extreme and Easy game mode handling
			if(game.gameMode == 1 && gameBegin == true && game.difficulty == 0) {
